...
public class InputController {
	...
	/*  curl -i -X POST "http://admin:123456@localhost:8045/api/github/qq275860560/input/pageInput?pageNum=1&pageSize=10" 
	*/
	...
	/*  curl -i -X POST "http://admin:123456@localhost:8045/api/github/qq275860560/input/getInput?id=1" 
	*/
	...
	public Map<String, Object> getInput(@RequestParam Map<String, Object> requestMap)  throws Exception{
 	...
 	/*  curl -i -X POST "http://admin:123456@localhost:8045/api/github/qq275860560/input/saveInput?name=inputname1&readerId=&readerName=mysqlreader&readerParameterUsername=root&readerParameterPassword=123456&readerParameterColumn=id,name&readerParameterConnectionJdbcUrl=&readerParameterConnectionTable=job" 
	*/
	...
	/*  curl -i -X POST "http://admin:123456@localhost:8045/api/github/qq275860560/input/updateInput?id=2&name=inputname2" 
	*/
	...
	/*  curl -i -X POST "http://admin:123456@localhost:8045/api/github/qq275860560/input/deleteInput?id=2" 
	*/

...
public class TxtFileWriterDao {
	...
	public Map<String,Object> getTxtFileWriter(Object id) throws Exception { 
	    StringBuilder sb  = new StringBuilder();
	    List<Object> condition = new ArrayList<Object>();
	    sb.append(" SELECT id,name,type,parameterPath,parameterFileName,parameterWriteMode,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from txtFileWriter where 1=1 "); 
	    if (!StringUtils.isEmpty(id)) {
	    	sb .append(" and id = ? ");
	    	condition.add(id);
	    }
	...
	public List<Map<String,Object>> listTxtFileWriter( String id,String name,String type,String parameterPath,String parameterFileName,String parameterWriteMode,String createUserId,String createUserName,String startCreateTime,String endCreateTime) throws Exception  {
	    StringBuilder sb  = new StringBuilder();
	    List<Object> condition = new ArrayList<Object>();
	    sb.append(" SELECT id,name,type,parameterPath,parameterFileName,parameterWriteMode,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from txtFileWriter where 1=1 "); 
	    if (!StringUtils.isEmpty(id)) {
	...
	public Map<String,Object> pageTxtFileWriter( String id,String name,String type,String parameterPath,String parameterFileName,String parameterWriteMode,String createUserId,String createUserName,String startCreateTime,String endCreateTime,Integer pageNum,Integer pageSize) throws Exception  {

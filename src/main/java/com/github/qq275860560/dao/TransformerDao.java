...
public class TransformerDao {
	...
	public Map<String,Object> getTransformer(Object id) throws Exception { 
	    StringBuilder sb  = new StringBuilder();
	    List<Object> condition = new ArrayList<Object>();
	    sb.append(" SELECT id,name,transformerType,transformerParameterCode,transformerParameterExtraPackage,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from transformer where 1=1 "); 
	    if (!StringUtils.isEmpty(id)) {
	    	sb .append(" and id = ? ");
	    	condition.add(id);
	    }
	...
	public int saveTransformer( Map<String,Object> map)  throws Exception  {
	    ...
	    sb1.append("transformerParameterCode").append(",");
	    sb2.append("?,");
	    condition.add(map.get("transformerParameterCode"));

	    sb1.append("transformerParameterExtraPackage").append(",");
	    sb2.append("?,");
	    condition.add(map.get("transformerParameterExtraPackage"));
	...
	public int updateTransformer( Map<String,Object> map) throws Exception  {
	    ...
	    sb.append(" transformerParameterCode = ? ,");
	    condition.add(map.get("transformerParameterCode"));
	    
	    sb.append(" transformerParameterExtraPackage = ? ,");
	    condition.add(map.get("transformerParameterExtraPackage"));
	...
	public List<Map<String,Object>> listTransformer( String id,String name,String transformerType,String transformerParameterCode,String transformerParameterExtraPackage,String createUserId,String createUserName,String startCreateTime,String endCreateTime) throws Exception  {
	    StringBuilder sb  = new StringBuilder();
	    List<Object> condition = new ArrayList<Object>();
	    sb.append(" SELECT id,name,transformerType,transformerParameterCode,transformerParameterExtraPackage,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from transformer where 1=1 "); 
	    if (!StringUtils.isEmpty(id)) {
	    ...
	    if (!StringUtils.isEmpty(transformerParameterCode)) {
	    	sb .append(" and transformerParameterCode like ? ");
	    	condition.add("%"+transformerParameterCode+"%");
	    }
	    if (!StringUtils.isEmpty(transformerParameterExtraPackage)) {
	    	sb .append(" and transformerParameterExtraPackage like ? ");
	    	condition.add("%"+transformerParameterExtraPackage+"%");
	    }
	...
	public Map<String,Object> pageTransformer( String id,String name,String transformerType,String transformerParameterCode,String transformerParameterExtraPackage,String createUserId,String createUserName,String startCreateTime,String endCreateTime,Integer pageNum,Integer pageSize) throws Exception  {

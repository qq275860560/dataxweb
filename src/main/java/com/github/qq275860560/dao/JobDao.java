...
public Map<String,Object> getJob(Object id) throws Exception { 
    StringBuilder sb  = new StringBuilder();
    List<Object> condition = new ArrayList<Object>();
    sb.append(" SELECT id,name,inputId,inputName,readerId,readerName,outputId,outputName,writerId,writerName,dataxJson,status,progress,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from job where 1=1 "); 
    if (!StringUtils.isEmpty(id)) {
    	sb .append(" and id = ? ");
    	condition.add(id);
    }
...
public List<Map<String,Object>> listJob( String id,String name,String inputId,String inputName,String readerId,String readerName,String outputId,String outputName,String writerId,String writerName,String dataxJson,Integer status,Double progress,String createUserId,String createUserName,String startCreateTime,String endCreateTime) throws Exception  {
    StringBuilder sb  = new StringBuilder();
    List<Object> condition = new ArrayList<Object>();
    sb.append(" SELECT id,name,inputId,inputName,readerId,readerName,outputId,outputName,writerId,writerName,dataxJson,status,progress,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from job where 1=1 "); 
    if (!StringUtils.isEmpty(id)) {
...
public Map<String,Object> pageJob( String id,String name,String inputId,String inputName,String readerId,String readerName,String outputId,String outputName,String writerId,String writerName,String dataxJson,Integer status,Double progress,String createUserId,String createUserName,String startCreateTime,String endCreateTime,Integer pageNum,Integer pageSize) throws Exception  {

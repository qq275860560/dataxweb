...
public Map<String,Object> getPlugin(Object id) throws Exception { 
    StringBuilder sb  = new StringBuilder();
    List<Object> condition = new ArrayList<Object>();
    sb.append(" SELECT id,name,type,source,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from plugin where 1=1 "); 
    if (!StringUtils.isEmpty(id)) {
    	sb .append(" and id = ? ");
    	condition.add(id);
    }
...
public List<Map<String,Object>> listPlugin( String id,String name,Integer type,String source,String createUserId,String createUserName,String startCreateTime,String endCreateTime) throws Exception  {
    StringBuilder sb  = new StringBuilder();
    List<Object> condition = new ArrayList<Object>();
    sb.append(" SELECT id,name,type,source,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from plugin where 1=1 "); 
    if (!StringUtils.isEmpty(id)) {
...
public Map<String,Object> pagePlugin( String id,String name,Integer type,String source,String createUserId,String createUserName,String startCreateTime,String endCreateTime,Integer pageNum,Integer pageSize) throws Exception  {

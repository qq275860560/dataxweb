...
public class InputDao {
	...
	public Map<String,Object> getInput(Object id) throws Exception { 
	    StringBuilder sb  = new StringBuilder();
	    List<Object> condition = new ArrayList<Object>();
	    sb.append(" SELECT id,name,readerId,readerName,readerParameterUsername,readerParameterPassword,readerParameterColumn,readerParameterWhere,readerParameterConnectionJdbcUrl,readerParameterConnectionTable,createUserId,createUserName,date_format(createTime,	'%Y-%m-%d %H:%i:%s') createTime from input where 1=1 "); 
	    if (!StringUtils.isEmpty(id)) {
	    	sb .append(" and id = ? ");
	    	condition.add(id);
	    }
	...
	public Map<String,Object> pageInput( String id,String name,String readerId,String readerName,String readerParameterUsername,String readerParameterPassword,String readerParameterColumn,String readerParameterWhere,String readerParameterConnectionJdbcUrl,String readerParameterConnectionTable,String createUserId,String createUserName,String startCreateTime,String endCreateTime,Integer pageNum,Integer pageSize) throws Exception  {

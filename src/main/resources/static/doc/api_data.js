define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>停止计划任务的当前构建，成功code返回200</p> <p><font color=\"red\">适用场景：</font></p>\t <p><li><font color=\"red\">数据交换组件-计划任务管理-停止</font></li></p>",
    "header": {
      "fields": {
        "Header": [
          {
    ...
    "examples": [
      {
        "title": "命令行调用示例: \t",
        "content": "curl -i -X POST 'http://localhost:8045/api/job/stopJob?id=1' -H \"Authorization:Bearer admin_token\"",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "name": "_api_transformer_checkTransformer",
    "version": "1.0.0",
    "permission": [
      {
        "name": "user"
  ...
  },
  {
    ...
    "title": "删除交换清洗",
    "group": "TransformerController",
    "name": "_api_transformer_deleteTransformer",
    "version": "1.0.0",
    "permission": [
      {
        "name": "user"
  ...
  },
  {
    ...
    "title": "获取交换清洗详情",
    "group": "TransformerController",
    "name": "_api_transformer_getTransformer",
    "version": "1.0.0",
    "permission": [
      {
        "name": "user"
  ...
  },
  {
    ...
    "title": "分页搜索交换清洗",
    "group": "TransformerController",
    "name": "_api_transformer_pageTransformer",
    "version": "1.0.0",
    "permission": [
      {
        "name": "user"
  ...
  },
  {
    ...
    "title": "保存交换清洗",
    "group": "TransformerController",
    "name": "_api_transformer_saveTransformer",
    "version": "1.0.0",
    "permission": [
      {
        "name": "user"
  ...
  },
  {
    ...
    "title": "更新交换清洗",
    "group": "TransformerController",
    "name": "_api_transformer_updateTransformer",
    "version": "1.0.0",
    "permission": [
      {
        "name": "user"

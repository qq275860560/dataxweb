 ...
 */
define(['vue','text!./saveFtpReader.html'], function (Vue,componentTemplate) {	
	let componentProperties = {
	 	...
	 	return Vue.component('saveFtpReader',  componentProperties);

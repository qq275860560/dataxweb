 ...
 */
define(['vue','text!./saveHttpReader.html'], function (Vue,componentTemplate) {	
	let componentProperties = {
			...
			data:function() {
				return {
					query:{ 
						name:"",
						type:"",
						parameterPath:"http://localhost:8045/doc/test.txt",
	 	...
	 	return Vue.component('saveHttpReader',  componentProperties);

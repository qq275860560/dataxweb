 ...
 */
define(['vue','text!./saveHttpWriter.html'], function (Vue,componentTemplate) {	
	let componentProperties = {
			...
			data:function() {
				return {
					query:{ 
						name:"",					
						type:"",									
						parameterPath:"http://localhost:8045/upload",
	 	...
	 	return Vue.component('saveHttpWriter',  componentProperties);

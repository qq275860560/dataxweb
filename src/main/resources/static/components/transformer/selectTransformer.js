 ...
 */
define(['vue','text!./selectTransformer.html'], function (Vue,componentTemplate) {	
	let componentProperties = {
		    ...
		    methods: {
				...
				pageTransformer:function(pageNum,pageSize){	
					let tmpVue=this;
					let url=this.$store.state.BASE_PATH+"/api/github/qq275860560/transformer/pageTransformer?pageNum="+pageNum+"&pageSize="+pageSize+"&name="+this.name+"&startCreateTime="+this.startCreateTime+"&endCreateTime="+this.endCreateTime;
				...
				repaint:function(){					
		       	...
		       	selectTransformer: function () {			       		
		       		//发送请求告知服务器
		       		this.hide();		
		       			
		       		this.$emit('setTransformer',this.selectItemId,this.selectItemName);		       					       					
		       	},  
		        hide:function (){
		    	   $('#selectTransformerModal').modal('hide');
		    	},
		...
		return Vue.component('selectTransformer', componentProperties);	
}); 
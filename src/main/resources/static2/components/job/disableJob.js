define(['vue','text!./disableJob.html'], function (Vue,componentTemplate) {	
	let componentProperties = {
		    ...
		    methods: {
		    	updateRouterView:function(path,query) {
		       	...
		       	disableJob: function () {			       		
		       		...
		       		let tmpVue=this;
		       		let url=this.$store.state.BASE_PATH+"/api/github/qq275860560/job/disableJob?id="+this.query.id;
		...
		return Vue.component('disableJob', componentProperties);	
}); 